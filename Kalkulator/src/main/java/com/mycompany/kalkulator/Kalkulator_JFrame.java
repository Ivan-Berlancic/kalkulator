 ...
 * @author Ivan
 */
public class Kalkulator_JFrame extends javax.swing.JFrame {

    /**
     * Creates new form Kalkulator_JFrame
     */
    double num, ans;
    int calculation;

    public Kalkulator_JFrame() {
        initComponents();
    }

    public void aritmethic_operations() {
        switch (calculation) {
            case 1: //zbrajanje
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kalkulator_JFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kalkulator_JFrame().setVisible(true);
            }
        });
    }
